import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, watch, defineComponent, provide, createElementBlock, isRef, isShallow, isReactive, defineAsyncComponent, Suspense, nextTick, Transition, useSSRContext, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-DxxzfNQQ.js").then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    ...
    component: () => import("./_nuxt/test-DBVM1A4_.js").then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-Ciweo1So.js").then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-B0vn7OyL.js").then((r) => r.default));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BtdHmSO1.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DQPHvTIR.js").then((r) => r.default || r));
